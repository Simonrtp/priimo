...
export default function WorkspacePanel({ children }: { children: ReactNode }) {
  return (
    <div className="relative min-h-0 flex-1 overflow-x-hidden overflow-y-auto rounded-tl-[22px] rounded-tr-clay-lg rounded-b-clay-lg border border-black/[0.06] bg-surface shadow-clay md:rounded-tl-[28px]">
      <WorkspaceBackdrop />
