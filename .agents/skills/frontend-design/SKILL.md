...
description: Guides creation of distinctive, production-grade frontend interfaces that avoid generic "AI slop" aesthetics. Use when building UI components, pages, or full interfaces where visual quality, memorability, and intentional design direction matter.
---
