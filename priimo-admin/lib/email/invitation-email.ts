...
export async function sendCollaboratorInvitationEmail(params: {
  ...
  const intro = params.directorFullName
    ? `${escapeHtml(params.directorFullName)}, directeur de ${safeAgency}, vous invite à rejoindre son agence sur Priimo,
                la plateforme de prospection immobilière prédictive.`
    : `L'agence ${safeAgency} vous invite à la rejoindre sur Priimo,
                la plateforme de prospection immobilière prédictive.`;
