...
export default function TourneeMobile({
  ...
  /** Secteur du jour, ou journée de relances. Null si l'agence n'a pas de calendrier. */
  bandeauZone?: string | null;
}) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-bg-base">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto pb-28 pt-5">
        ...
        {bandeauZone ? (
          <p className="mb-3 rounded-xl bg-surface px-3 py-2.5 text-[13.5px] font-medium text-text-strong">
            {bandeauZone}
          </p>
        ) : null}
