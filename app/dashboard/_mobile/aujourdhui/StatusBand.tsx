...
function AccountButton({
  ...
  return (
    <button
      ...
      className={`app-press flex size-9 flex-shrink-0 items-center justify-center rounded-full text-[11px] font-semibold ${className}`}
      style={
        shell
...
export function StatusBand({
  ...
  return (
    <header
      className={`z-[10] flex flex-shrink-0 gap-3 px-4 ${
        shell
